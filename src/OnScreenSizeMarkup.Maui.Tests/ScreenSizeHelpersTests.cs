...
public class ScreenSizeHelpersTests
{
    ...
    public void TestOnScreenSize_IConvertible(ScreenCategories screenCategory, IConvertible baseSize, double factor, double expected)
    {
        ...
        double result = (double)screenSizeHelpers.GetScreenSizeScaled(baseSize, extraSmallFactor: factor, smallFactor: factor, mediumFactor: factor, largeFactor: factor, extraLargeFactor: factor);
